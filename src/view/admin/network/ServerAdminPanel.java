...
public class ServerAdminPanel extends JPanel {
    ...
    private class StartServerButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            boolean result = networkService.startServer(port, ServerAdminPanel.this);
    ...
    private static ServerAdminPanel instance;
    ...
    public static ServerAdminPanel getInstance() {
        if (instance == null) {
            instance = new ServerAdminPanel();
        }

        return instance;
    }

    private ServerAdminPanel() {
        /*
         * Port
         */
