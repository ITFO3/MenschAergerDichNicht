...
public class SpielfeldCanvas extends Canvas implements Observer, MouseListener {
    ...
    public void paint(Graphics g) {
        ...
        Image image = new ImageIcon("D:/Dokumente/GitHub/MenschAergerDichNicht/src/view/pachisi-4er-blanco.jpg").getImage();
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        Figur f = Spielfeld.getInstance().sucheFigur(feld);
        if(f != null) {
            // Hier nur die neue Position setzen und an den Server senden.
            // Dort wird dann überprüft, ob geschmissen wird
            int neuePosition = Spielfeld.getInstance().bewegeFigur(f, Spielfeld.getInstance().getWurfAnzahl());
